...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <body class="antialiased">
        ...
        <script>
            ...
            const vehiculo = this.vehiculo.value; // Obtener el vehículo

            let url = '';

            // Redirigir según el rol seleccionado
            if (role === 'mecanico') {
                url = '/mecanico'; // Reemplazar con la ruta del mecánico
            } else if (role === 'disenador') {
                url = '/disenador'; // Reemplazar con la ruta del diseñador
            }

            // Enviar los datos a la nueva URL usando Fetch API
            fetch(url, {
                method: 'POST',
                headers: {
